...
function isDestructive(action: CaseWorkflowAction | "clearAudit" | "resetPersistence"): boolean {
  return action === "reject" || action === "clearAudit" || action === "resetPersistence";
}
    ...
    <>
      ...
      <section className="panel">
        ...
        <div className="notice-card" style={{ marginBottom: 12 }}>
          The backend currently accepts only Submit, Approve, and Reject. Prepare Publication, Publish, and Hold were removed because every tested route returned 404.
        </div>
